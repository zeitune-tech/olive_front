...
export class ProductionRegistryService {
    ...
    baseUrl = environment.administration_url + '/production-registries';
    ...
    create(productionRegistry: ProductionRegistry): Observable<ProductionRegistry> {
        return this._httpClient.post<ProductionRegistry>(`${this.baseUrl}/productionRegistries`, productionRegistry)
        .pipe(
