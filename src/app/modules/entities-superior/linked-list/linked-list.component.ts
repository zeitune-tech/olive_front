...
import { animations } from "@lhacksrt/animations";
    ...
    export class LinkedEntitySuperiorListComponent {
    ...
    ngOnInit(): void {
        this._entitySuperiorService.entitiesSuperiorLinked$
        .subscribe((data: EntitySuperior[]) => {
            this.data = data;
    ...
    /**
    */
    onDemand(item: EntitySuperior | null): void {
