...
export class LinkedCompaniesListComponent {
    ...
    */
    ...
    checkPermission() {
        this.permissions = {
            demand: this._permissionsService.hasPermission(this.user, PERMISSIONS.CREATE_DEMAND),
            attribute: this._permissionsService.hasPermission(this.user, PERMISSIONS.ATTRIBUTE_ATTESTATION)
        }
    }
