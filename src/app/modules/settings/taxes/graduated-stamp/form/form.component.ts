...
import { TaxService } from '@core/services/settings/product/product.service';
import { Tax } from '@core/services/settings/product/product.interface';
...
export class DimensionStampFormComponent implements OnInit {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<TaxDimensionStampFormComponent>,
        @Inject(MAT_DIALOG_DATA) public data: Tax,
        private _productService: TaxService,
