...
import { routes } from "./production-registries.routing";
...
@NgModule({
    declarations: [
        ProductionRegistriesListComponent,
        ProductionRegistryNewComponent
    ],
    imports: [
...
export class ProductionRegistriesModule { }